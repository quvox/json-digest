...
def _serialize(value):
    ...
    if isinstance(value, str):
        ...
        dt, d = _make_structure_digest_v1(value)
    elif isinstance(value, list):
        dt, d = _make_array_digest_v1(value)
...
def _make_array_digest_v1(jsondat):
    ...
    Returns:
        ...
        string: HEX string of the SHA256 digest of the array
    """
    res = list()
    str_to_evaluate = ""
    for v in jsondat:
...
def digest(jsonstr):
    ...
    if jsondat['digest_version'] == 1:
        dt, d = _make_structure_digest_v1(jsondat)
